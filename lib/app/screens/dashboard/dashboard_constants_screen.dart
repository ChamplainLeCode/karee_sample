...
///
///
/// `DashboardConstantsScreen` is set as Screen with name `dashboarn`
      ...
      body: SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Padding(
                ...
                child: Text('karee.module.constant.title'.translate(), style: Style.moduleTitleStyle)),
            Padding(
            ...
            Row(children: [
              ...
              Text.rich(TextSpan(children: [
                TextSpan(
                    ...
                    style: TextStyle(color: Colors.teal, fontWeight: FontWeight.w400, fontSize: 18),
                    children: [
                      TextSpan(
                        text: '.',
                        style: TextStyle(color: Colors.grey),
                      ),
                      TextSpan(text: 'production', style: TextStyle(color: Colors.blueGrey))
                    ])
              ]))
            ]),
            Padding(
              ...
              Text.rich(TextSpan(children: [
                TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(text: 'development', style: TextStyle(color: Colors.blueGrey))
                    ])
              ]))
            ]),
            Padding(
              ...
              Text.rich(TextSpan(children: [
                TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(text: 'kareeErrorScreenName', style: TextStyle(color: Colors.blueGrey))
                    ])
              ]))
            ]),
            Padding(
